            ...
            <div id = "stuff" class="w3-panel" style = "width:100%;height:30%;float:left;order:1;">
               ...
               <!--<div class = "w3-panel" style = "width:80%;height:100%;float:left;overflow-y:scroll;overflow-x:hidden">-->
                   ...
                   try(ResultSet fetching = conn.prepareStatement(fetchresources).executeQuery()) {
                    ...
                    while (fetching.next()) {
                        int resourceid = fetching.getInt("resource_id");
                        String resurl = fetching.getString("url");
                        Blob b = fetching.getBlob("name");
                        byte[] bdata = b.getBytes(1, (int) b.length());
                        String resname = new String(bdata, "UTF-8");
                    ...
                    %>
                        ...
                        <%
                            if (admin) {
                        %>
                            <form action="/deleteresource" style = "color: #eae672;" method="post" target="_self">
                                <input type="hidden" id="userid" name="userid" value="<%=userid%>" >
                                <input type="hidden" id="id" name="id" value="<%=groupid%>" >
                                <input type="hidden" id="group" name="group" value="<%=thegroup%>" >
                                <input type="hidden" id="resid" name="resid" value="<%=resourceid%>" >
                                <button type = "submit" style="color:#eae672;"><span class="close">&times;</span></button>
                            </form>
                            <br>
                       ...
                       <a href = "<%=resurl%>" target = "_blank"> <%=resname%>  </a> </blockquote>
