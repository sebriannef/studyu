...
<body onload="addLoginOrLogoutLinkToNavigation();" style="background-color:#056691">
    ...
    %>
    <h1 align="center" style="color:#eae672;"> User Settings </h1>
    <br><br>

    <div class="form-container" align="center" style="height:50%;">

            <div align ="center" style="width:60%;height:60%;">
                <h3 align="center" style="color:#eae672;"> Change First Name </h3>
                ...
                <h3 align="center" style="color:#eae672;"> Change Last Name </h3>
                <form action = "/updateinfo" method = "post" target="_self">
                ...
                <h3 align="center" style="color:#eae672;"> Change School </h3>
                <form action = "/updateinfo" method = "post" target="_self">
                ...
                <h3 align="center" style="color:#eae672;"> Change Password </h3>
                <form action = "/updateinfo" method = "post" target="_self">
                ...
                <h3 align="center" style="color:#eae672;"> Change Email </h3>
                <form action = "/updateinfo" method = "post" target="_self">
                ...
                <h3 align="center" style="color:#eae672;"> Change Phone Number </h3>
                <form action = "/updateinfo" method = "post" target="_self">
